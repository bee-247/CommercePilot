...
from ..retrieval.embedding import EmbeddingService, embedding_service as _default_embedding_service
            ...
            insert_data = [
                {
                    ...
                    "text": doc["text"],
                    "resource_id": int(doc.get("resource_id") or 0),
                    ...
                    "document_type": doc.get("document_type", "product"),
                    "section_title": doc.get("section_title", ""),
                    "product_tags": doc.get("product_tags") or [],
