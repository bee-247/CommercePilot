        ...
        try:
            ...
            for doc in raw_docs:
                base_doc = {
                    ...
                    "resource_id": base_metadata.get("resource_id"),
                    "owner_id": base_metadata.get("owner_id"),
                    "visibility": base_metadata.get("visibility", "public"),
                    "category": base_metadata.get("category", ""),
                    "brand": base_metadata.get("brand", ""),
                    "business_line": base_metadata.get("business_line", ""),
                    "document_type": base_metadata.get("document_type", "product"),
                    "section_title": base_metadata.get("section_title", ""),
                    "product_tags": base_metadata.get("product_tags", []),
                }
